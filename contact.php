...
<head>
	...
	<title>Elimu na Ajira - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 34Ubungo</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:jobboard@gmail.com">zachariasabun@gmail.com </a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+255 714 209 545">+255 714 209 545</a>
								</li>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Elimu na Ajira</h5>
