...
<head>
	...
	<title>Elimu na Ajira - Job Portal</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="https://portal.ajira.go.tz">Ajira Portal TZ</a>
							</li>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>Nafasi za Kazi, Ajira Mpya, Ajira Portal and Jobs in Tanzania</h1>
					<p>Finding your next job or career on Elimu na Ajira</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Elimu&Ajira</h5>
											<p>Ajira na Elimu: Jukwaa bora kwa fursa za ajira na elimu. Tunajitahidi kuunganisha watu na fursa muhimu za ajira huku tukitoa ufahamu kuhusu mafanikio ya elimu.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Elimu&Ajira Contact</h5>
								
								<p>Address : 34Ubungo, Dar es salaam</p>
								<p>Email : <a href="zachariasabun@gmail.com">zachariasabun@gmail.com</a></p>
								<p>Phone : <a href="tel+255714209545">+255 714 209 545</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Elimu&Ajira</p>
